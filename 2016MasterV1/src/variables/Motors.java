...
//	public static Relay lightingControlSpike;
	...
	public static final double INNER_INTAKE_POWER = .68, OUTER_INTAKE_POWER = .80, ARM_POWER = -.58, SHOOTER_POWER = .725, TAPE_ARM_POWER = .75, INNER_OUTAKE_POWER = -1.0, ARM_DOWN_POWER = .50;
